...
Robot::ressources::ressources()
   ...
   m_log_file(LOG_FILE_PATH)
 {
    ...
    m_purple_finder = new ColorFinder(0, 15, 0, 0, 0.3, 50.0);
    httpd::purple_finder = m_purple_finder;

    m_black_finder = new ColorFinder(0, 15, 0, 0, 0.3, 50.0);
    httpd::black_finder = m_black_finder;

    m_white_finder = new ColorFinder(0, 15, 0, 100, 0.3, 50.0);
    httpd::white_finder = m_white_finder;
