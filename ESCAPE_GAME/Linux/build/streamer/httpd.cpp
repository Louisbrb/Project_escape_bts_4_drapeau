...
ColorFinder* httpd::black_finder;
ColorFinder* httpd::white_finder;
minIni*      httpd::ini;
...
void httpd::command(int fd, char *parameter) {
    ...
    else
    {
        ...
        else if(strcmp(section, "black") == 0) finder = black_finder;
        else if(strcmp(section, "white") == 0) finder = white_finder;
